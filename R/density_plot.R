#' density_plot
#' @description The density_plot function creates a density plot with alpha=0.5
...
#' @param x A continuous numerical variable in the dataset, it is one of the variables being investigated
#' @param fill A variable in the dataset, it is one of the variables being investigated
...
#'
#' @return A density plot with the value of x in x-axis across different fills and density as the y-axis
#' @export
